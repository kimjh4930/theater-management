insert into movie (director, grade, opening_date, running_time, title, version) values ('봉준호', 'PG15', '2019-05-30', 131, '기생충', 0);
insert into movie (director, grade, opening_date, running_time, title, version) values ('최동훈', 'PG18', '2006-09-28', 139, '타짜', 0);
insert into movie (director, grade, opening_date, running_time, title, version) values ('James Francis Cameron', 'PG12', '2009-12-17', 162, '아바타', 0);
